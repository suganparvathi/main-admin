    ...
    <nav>
      ...
      {/* <container> */}
        <div className='flexz-10  text-xl flex-col w-full h-full ml-6 mt-4 text-black'>
          ...
          <div className='flex flex-row p-3'><FaRegChartBar className=' text-2xl'/><Link to="/Demograph"><p className='ml-2'>Demographics</p></Link></div>
          <div className='flex flex-row p-3'><IoMdWallet className=' text-2xl'/><Link to="/Wallet"><p className='ml-2'>Wallet</p></Link></div>
          <div className='flex flex-row p-3'><MdOutlineRule className=' text-2xl'/><Link to="/delegate-task"><p className='ml-2'>Delegate Task</p></Link></div>
          <div className='flex flex-row p-3'onClick={ handleShowOptions}><RiChat3Line className=' text-2xl'/><p className='ml-2' >Chat</p></div>
          <div className='flex flex-row p-3'><ImUsers className=' text-2xl'/><Link to="/customer-support"><p className='ml-2'>Customer Services</p></Link></div>
