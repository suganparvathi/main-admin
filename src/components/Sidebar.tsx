...
export const Sidebar = () => {
  ...
  return (
    <nav>
      ...
      {/* <container> */}
        <div className='flexz-10  text-xl flex-col w-full h-full ml-6 mt-4 text-black'>
         
          <div className='flex flex-row font-thin p-3'><FaRegChartBar className=' text-2xl'/><Link to="/Demograph"><p className='ml-2'>Demographics</p></Link></div>
          ...
          <div className='flex flex-row font-thin p-3'onClick={ handleShowOptions}><RiChat3Line className=' text-2xl'/><p className='ml-2' >Chat</p></div>
          ...
          <div className='flex flex-row font-thin p-3'><TbArrowsRandom className='text-2xl'/><p className='ml-2'>Refunding</p></div>
          <div className='flex flex-row font-thin p-3'><FaPenSquare className='text-2xl'/><p className='ml-2'>Trips History</p></div>
          <div className='flex flex-row font-thin p-3'><FaBuysellads className=' text-2xl'/><p className='ml-2'>Place Ads</p></div>
          <div className='flex flex-row font-thin p-3'><FaIdCard className=' text-2xl'/><p className='ml-2'>Profile</p></div>
          <div className='flex flex-row font-thin p-3'><BiLogOut className=' text-2xl'/><p className='ml-2'>Logout</p></div>
