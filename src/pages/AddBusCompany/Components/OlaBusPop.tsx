  ...
  return (
    ...
    <div className="w-[80%] rounded-3xl text-white flex flex-col z-20  -ml-20 h-[70%] bg-black">
      ...
      <div className="w-[50%]  h-[30%]">
        ...
        <p className="ml-8 mt-4 text-xl">Created Date<span className="font-bold ml-2 text-xl">: 4th August 2021 / 6:00 Am</span></p>
        <p className="ml-8 mt-4 flex flex-row text-xl">Owner ID Proof<span className="font-bold ml-2 text-xl">: Aadhar Card</span><p className="ml-10 text-2xl"><HiOutlineDownload/></p></p>
