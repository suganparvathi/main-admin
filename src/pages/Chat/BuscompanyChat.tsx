...
const BuscompanyChat = ({ isYours, message, status }: ChatProps) => {
  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div className='rounded-full drop-shadow-xl bg-white justify-center flex items-center w-10 h-10 rounded-full ml-2'>
