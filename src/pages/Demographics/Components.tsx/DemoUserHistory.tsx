          ...
          <Overlay onClick={handleShowOptions} />
              ...
              <div className="absolute w-full justify-center flex h-full">
                ...
                <div className="w-full h-[25%] justify-center text-xl font-bold items-center flex flex-row">
                    <Link to="/view-user-history" className="w-[40%]  hover:scale-90 h-[40%] items-center justify-center flex rounded-3xl drop-shadow-2xl bg-white text-black">View User History</Link>
                    <button className="w-[40%] h-[40%] ml-10  rounded-3xl  hover:scale-90 items-center justify-center flex drop-shadow-2xl bg-white text-black">Download User History</button>
      ...
      {showMoreOptions1 && (
         ...
         <div className="absolute w-full justify-center flex h-full">
                ...
                <div className="w-full h-[25%] justify-center text-xl font-bold  flex flex-row">
                    <Link to="/pilots-and-copilots-history" className="w-[40%] h-[40%]  hover:scale-90 items-center mt-4 justify-center flex rounded-3xl drop-shadow-2xl bg-white text-black">View User History</Link>
                    <button className="w-[40%] h-[40%] ml-10  hover:scale-90  rounded-3xl mt-4  items-center justify-center flex drop-shadow-2xl bg-white text-black">Download User History</button>
            ...
            <div className="text-white relative flex flex-row  justify-center items-center w-full  h-full font-semibold ">
                ...
                <div className="flex flex-row items-center mt-2 text-white w-full h-[40%] font-semibold ">
                    <div className="w-[8%] h-[40%] ml-4  flex items-center">Filter By <span className="ml-4 text-2xl"><FiFilter/></span></div>
                   {
                    ...
                    className={`w-[13%] h-[50%] ml-2  hover:scale-90 flex justify-center items-center  rounded-3xl  border border-white 
               ...
               <div className="w-[50px]" > <img src="https://miro.medium.com/max/785/0*Ggt-XwliwAO6QURi.jpg" 
                        className="rounded-full  hover:scale-90  w-[50px] h-[50px]"onClick={handleShowOptions} /></div>
                        <p>{name}</p>
        ...
        <div className="w-[8%] h-[35%] ml-6 flex items-center">Filter By <span className="ml-4 text-2xl"><FiFilter/></span></div>
            {
                ...
                className={`w-[12%] h-[40%] ml-2  hover:scale-90 flex justify-center   items-center rounded-3xl  border border-white 
            ...
            <div className="w-full flex-row text-white items-center -mt-16 flex w-[90%] h-full  overflow-x-scroll">
                ...
                <div className='flex items-center justify-center ml-12 flex flex-col  w-[70%] h-full'>
                <div className="w-[50px]"> <img src="https://miro.medium.com/max/785/0*Ggt-XwliwAO6QURi.jpg" className="rounded-full  hover:scale-90 w-[50px] h-[50px]" onClick={handleShowOptions1}/></div>
                    <p>{name}</p>
                    </div>
                ))}
        </div>
