...
const members = [
    { name : "OLA Bus Completed The Trip (OLA-09875)",date:"Date : 04:08:2021",time:"Time : 11:00 A.M"},
    { name : "Red Bus  Completed The Trip (RED-90854)",date:"Date : 05:08:2021",time:"Time : 01:00 A.M"},
    { name : "UBER Bus  Completed The Trip (UBER-90785)",date:"Date : 05:08:2021",time:"Time : 01:00 A.M"},
   ]  
       ...
       <div className="flex  w-full h-[5%] ">
        ...
        <div className="w-full h-full flex justify-center ">
          <div className="mt-4 w-[90%] h-full bg-quaternary rounded-xl">
            <div className="w-full h-[10%]  flex justify-center items-center text-white font-bold text-3xl">Trips</div>
            <div className="w-full h-[10%]  text-white text-xl"><Searchbar placeholder= "Search By Driver ID/ Bus Company /Bus Name / Bus Number"/> </div>
